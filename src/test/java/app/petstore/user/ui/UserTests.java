...
public class UserTests {
	...
	public static void loginValidTest() throws InterruptedException, IOException {
		...
		takeScreenshot("3");
		// TODO - ask - in DashboardPage i have constructor(it have to be right? because
		// the Class use the "driver". i ask: i cant call in static way to isLoggedin()
		// whithout constructor here)
		// and you told me maybe to return POM inside another POM (like loginPage). i
		// did something, option1

		// option 2
		// DashboardPage dashboardPage = new DashboardPage(driver);
		// TODO - ask - to check the opposite (failure) i need to create another Test or
		// to assert here just to false? - another test
...
//        logger.info("Car2: " + car2);
	...
	public static void loginNotValidTest() throws InterruptedException {
		...
		// TODO - ask - the app is crash here if no dahboardPage, so i did something in
		// isLoggedin(). tell me if it's good
